                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="img_product">
                                <img src="{{asset('local/storage/app/product/'.$item->product_imgcov.'')}}" width="100%" alt="Avatar" class="image_product">
                            </div>
                            <div class="text_product">
                                <div class="product-name">
                                    ...
                                    <div class="product-price2 text-center">
                                        <button type="button" class="btn btn-black-unavialable rounded-0 text-center" style="color: #fff;"><a href="{{url('product_detail', $item->product_id)}}">
                                            <img src="{{asset('smb-frontend/images/cart_small.png')}}"> VIEW PRODUCT</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
