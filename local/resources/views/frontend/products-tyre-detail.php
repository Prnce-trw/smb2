...
<head>
    <title>195/55R15 PILOT SPORT 3 - SMB</title>
...
<body>
    ...
    <div class="banner-page head-about-us-5 ">
        <div class="centered headPage-text">
            <a id="orange18" style="padding-left: 15px">หน้าหลัก / สินค้า MICHELIN /</a><a id="orange17"> 195/55R15 PILOT SPORT 3</a>
        </div>
    </div>
    <div class="container mt-5 mb-5" id="textproductI">
        <div class="row">
                    ...
                    <div class="flex-viewport" style="overflow: hidden; position: relative;">
                        <ul class="slides" style="width: 1000%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
                            <li class="flex-active-slide" style="width: 445px; margin-right: 0px; float: left; display: block;">
                                <img src="images/products-detail/tyre/01.png" class="img-fluid" draggable="false">
                            </li>
            ...
            <div class="col-lg-7" id="idpt">
                <div class="row">
                    <div class="col-lg-12">
                        <h4><img src="https://www.b-quik.com/image/brand/yar24gaag1.michelin.png" style="max-width: 145px; max-height: 44px" alt="logo" onerror="this.onerror=null; this.src='https://www.b-quik.com/image/brand/mock.jpg'"></h4>
                        <div class="product-text mt-2">
                            <h5 id="textproducTss" class="text-black font-weight-medium">195/55R15 PILOT SPORT 3</h5>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-xs-6 pl-0 pr-0">
                                <div class="d-flex flex-wrap">
                                    <div class="p-2 bd-highlight flex-product">
                                        <img src="images/icon/wheel01.png" alt="product">
                                        <div>นุ่มเงียบ</div>
                                    </div>
                                    <div class="p-2 bd-highlight flex-product">
                                        <img src="images/icon/wheel02.png" alt="product">
                                        <div>ยึดเกาะถนน</div>
                                    </div>
                                    <div class="p-2 bd-highlight flex-product">
                                        <img src="images/icon/wheel03.png" alt="product">
                                        <div>ลายสปอร์ต</div>
                                    </div>
                                    <div class="p-2 bd-highlight flex-product">
                                        <img src="images/icon/wheel04.png" alt="product">
                                        <div>รีดน้ำดี</div>
                                    </div>
                                    <div class="p-2 bd-highlight flex-product">
                                        <img src="images/icon/wheel05.png" alt="product">
                                        <div>ตอบสนองเร็ว</div>
                                    </div>
                                    <div class="p-2 bd-highlight flex-product">
                                        <img src="images/icon/wheel06.png" alt="product">
                                        <div>เข้าโค้งแม่นยำ</div>
                                    </div>
                                </div>
                                <div class="text-center mt-2 mb-2"><img src="images/detail-wheel.jpg" alt="product" class="responsive2"></div>
                                ...
                                <div class="table-responsive mb-2" style="overflow: initial;">
                                    <table class="table table-bordered table-striped" style="width: 100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    เส้นผ่านศูนย์กลางกระทะล้อ (นิ้ว)
                                                </td>
                                                <td align="right" width="50%" class="info_detail">
                                                    15
                                                </td>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    ขีดจำกัดการรับน้ำหนักต่อล้อ (กก.)
                                                </td>
                                                <td align="right" width="50%" class="info_detail">
                                                    750
                                                </td>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    ค่าเปรียบเทียบการสึกหรอ
                                                    <sup class="footnote"><a href="#footnote-1" aria-label="Footnote 1" style="color: #ff8200!important;">1</a></sup>
                                                </td>
                                                <td align="right" width="50%" class="info_detail">
                                                    212
                                                </td>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    ความสามารถในการหยุดบนทางเปียก
                                                    <sup class="footnote"><a href="#footnote-2" aria-label="Footnote 2" style="color: #ff8200!important;">2</a></sup>
                                                </td>
                                                <td align="right" width="50%" class="info_detail">
                                                    A
                                                </td>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    ...
                                                    <sup class="footnote"><a href="#footnote-3" aria-label="Footnote 3" style="color: #ff8200!important;">3</a></sup>
                                                </td>
                                                <td align="right" width="50%" class="info_detail">
                                                    A
                                                </td>
                                ...
                                <div class="table-responsive mb-2" style="overflow: initial;">
                                    <table style="width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td width="50%">
                                                    <h3><img src="images/icon/bath1.jpg" alt="data"> ราคาโปรโมชั่นต่อเส้น </h3>
                                                </td>
                                                <td align="right" width="50%" class="info_detail">
                                                    <h3 style="color: #FF0000">3,550 บาท</h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="50%">
                                                    <h3><img src="images/icon/bath2.jpg" alt="data"> ราคาปกติ </h3>
                                                </td>
                                                <td align="right" width="50%" class="info_detail">
                                                    <h3>3,750 บาท</h3>
                                                </td>
                                    ...
                                    <div class="form-group">
                                        <div class="col text-center">
                                            <a href="products.php"><button type="button" class="btn btn-warning btn-home col-xl-5 col-md-5 mt-2"><img src=" https://www.b-quik.com/front/images/tyre.png" alt="map"> ยางทั้งหมด </button></a>
                                    ...
                                    <div class="owl-news loop owl-carousel owl-theme my-3" data-aos="fade-up">
                                        <div class="item">
                                            <div class="card newsIndex">
                                                <img class="card-img-top box-homenew-2" src="images/products-detail/tyre/slide01.jpg" alt="Card image">
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="card newsIndex">
                                                <img class="card-img-top" src="images/products-detail/tyre/slide01.jpg" alt="Card image">
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="card newsIndex">
        ...
        <section class="ac-gf-sosumi" aria-label="Footnotes" id="footdetail">
            <ol>
                <li id="footnote-1">ค่าเปรียบเทียบการสึกหรอ ยิ่งค่านี้มีตัวเลขต่ำยางจะนิ่มและเกาะถนนได้ดี แต่จะสึกหรอเร็ว กลับกัน หากค่านี้มีตัวเลขสูง ยางจะกระด้างขึ้น แต่สามารถใช้งานได้ทนทาน</li>
                <li id="footnote-2">ความสามารถในการหยุดบนถนนเปียก มีระดับตั้งแต่ AA, A, B และ C ระดับ AA มีสมรรถนะดีที่สุด</li>
                <li id="footnote-3">ความสามารถในการระบายความร้อน มีระดับตั้งแต่ A, B และ C ระดับ A มีสมรรถนะดีที่สุด</a>
                </li>
