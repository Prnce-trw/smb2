...
<head>
    ...
    <style>
        ...
        .owl-carousel .owl-nav button.owl-next {
            background-image: url('smb-frontend/images/index-slide/next.png');
            position: absolute;
            right: -85px;
            outline: none;
            background-color: none;
...
<body>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-10">
                                ...
                                <form action="{{url('searchbyname')}}" method="POST" id="selecBy_name">
                                    @csrf
                    ...
                    <div class="col-lg-8 left-border-color">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-3">
                                <form action="{{url('search_wheelByCar')}}" method="POST" id="searchbycar_wheels">
                                    @csrf
                                <label for="carbrand">
            ...
            <div id="tab3" class="tab-pane fade">
                <div class="row">
                    ...
                    <div class="col-lg-8 left-border-color">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-3">
                                <form action="{{url('search_tireByCar')}}" method="post" id="searchtirebycar">
                                @csrf
                    ...
                    <div id="carousel-smb-1" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('smb-frontend/images/index-slide/1.jpg')}}" alt="First slide">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-5">
                <div class="col-lg-4 border-carousel">
                    <div id="carousel-smb-2" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('smb-frontend/images/index-slide/2.jpg')}}" alt="First slide">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-5">
                <div class="col-lg-4 border-carousel">
                    <div id="carousel-smb-3" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('smb-frontend/images/index-slide/3.jpg')}}" alt="First slide">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-deck">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" id="cardT">
                        <p class="card-text" style="margin-bottom: 0px;margin-top: 10px"><small class="text-muted" style="font-weight: 400;font-size: 14px;"></i> {{$item->news_date}}</small></p>
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '.filterSize', function () { 
            var sizeDiameter = $('#selectSize').val();
            var sizePcd = $('#selectPcd').val();
