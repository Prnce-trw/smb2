    ...
    <style>
        ...
        * {
        ...
        .owl-carousel .owl-nav button.owl-prev {
            ...
            height: 34px;
            outline: none;
            background-image: url('smb-frontend/images/products-detail/owl-prev.png');
        }

        .owl-carousel .owl-nav button.owl-next {
            background-image: url('smb-frontend/images/products-detail/owl-next.png');
            position: absolute;
            right: -50px;
            outline: none;
            background-color: none;
...
<body>
                    ...
                    <div class="flex-viewport" style="overflow: hidden; position: relative;">
                        <ul class="slides" style="width: 1000%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
                            ...
                            <li class="flex-active-slide" style="width: 445px; margin-right: 0px; float: left; display: block;">
                                <img src="{{asset('local/storage/app/productgallery/'.$item->product_imgset_name.'')}}" class="img-fluid" draggable="false">
                            </li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="col-lg-7" id="idpt">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="product-text">
                            <a>SIZE : 
                                @foreach ($product->getProductSizes as $value_size)
                        ...
                        <div class="product-text">
                            <a>PCD : 
                                @foreach ($product->getProductPcds as $value_pcd)
                                {{$value_pcd->pcd_name}}
                                @endforeach
                            </a>
                        </div>
                        <div class="product-text">
                            <a>ET : 
                                @foreach ($product->getProductEts as $value_et)
                                {{$value_et->et_name}}
                                @endforeach
                            </a>
                        </div>
                        ...
                        {{-- <div class="select-size">
                            ...
                            <input type="radio" name="s-size" id="{{$key}}" {{ $key == 0 ? "checked" : "" }} />
                            <label for="{{$key}}">{{$item->size_diameter}}</label>
                            @endforeach
                        </div> --}}
                        @foreach ($product->getProductSizes_frontend as $key => $item)
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="{{$key}}" value="{{$item->size_id}}">
                            <label class="form-check-label" for="{{$key}}">{{$item->size_diameter}}x{{$value_size->size_width}}</label>
                        </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <button type="button" class="btn btn-black rounded-0" onclick="addtoCart({{$product->product_id}})" style="color: #fff;" id="lk">ใส่ตะกร้าสินค้า</button>
                        {{-- <a href="cart.php" ></a> --}}
                    </div>
                </div>
                @endif
                <div class="d-flex flex-wrap">
                    <div class="p-2 bd-highlight flex-product">
                        <img src="{{asset('smb-frontend/images/products-detail/delivery.jpg')}}" alt="product">
                    </div>
                    <div class="p-2 bd-highlight flex-product">
                        <img src="{{asset('smb-frontend/images/products-detail/payment.jpg')}}" alt="product">
                    </div>
                    <div class="p-2 bd-highlight flex-product">
                        <img src="{{asset('smb-frontend/images/products-detail/unk.jpg')}}" alt="product">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function addtoCart(productId) {
            ...
            if (size != null && amountProduct != null) {
                $.ajax({
                    url: '{{url('AddtoCart')}}',
                    type: 'GET',
                    data: {
