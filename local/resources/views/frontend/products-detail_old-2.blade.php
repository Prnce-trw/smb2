...
<head>
    ...
    <style>
        ...
        * {
        ...
        .tabs-size .nav-pills .nav-link {
            display: block;
            padding: 5px;
            background-color: #ebebeb;
        }

        .tabs-size .nav-pills .nav-link:hover,
        .tabs-size .nav-pills .nav-link.active,
        .tabs-size .nav-pills .show>.nav-link {
            color: #363636;
            background-color: #ff8200;
        }

        .tabs-size .tab-content .tab-pane ul {
            padding-left: 0;
        }

        .tabs-size .tab-content .tab-pane ul li {
            width: 100%;
            display: table;
            list-style: none;
            background: #ebebeb;
        ...
        .tabs-size .tab-content .tab-pane ul li:hover {
            background: #ff8200;
        }

        .tabs-size .tab-content .tab-pane ul li.header {
            background: #363636;
            color: #ff8200;
        }

        .tabs-size .tab-content .tab-pane ul li span {
            width: 33.33%;
            display: block;
            float: left;
            padding: 2px 5px;
        ...
        <div class="row">
            <div class="col-lg-5 label-relative">
                ...
                <div class="society-set select-display-slide">
                    @foreach ($color[0]->getColorImgset as $key => $item)
                    <li class="{{ $key == 0 ? "active" : "" }}" rel="{{$key}}">
                        <a href="javascript:void(0)"><img src="{{asset('local/storage/app/productimgset/'.$item->product_imgset_name.'')}}" class="img-fluid"></a>
                    </li>
                    @endforeach
                </div>
                <div class="society-content">
                    ...
                    <div class="display-slide" rel="{{$key}}" style="{{ $key == 0 ? "display:block;" : "" }}">
                        <img src="{{asset('local/storage/app/productimgset/'.$item->product_imgset_name.'')}}" class="img-fluid">
                    </div>
                    @endforeach
                </div>
                <div class="pd-color">
            ...
            <div class="col-lg-7" id="idpt">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="product-text">
                            <h4 id="orange17" style="color: black">{{$product->product_name}}</h4>
                            {{-- <img src="{{asset('smb-frontend/images/products-detail/cosmic-logo.png')}}"> --}}
                        </div>
                        <div class="tabs-size">
                            <ul class="nav nav-pills mb-3" role="tablist">
                                @foreach ($color[0]->getSizes as $key => $item)
                                <li class="nav-item">
                                    <a class="nav-link filter_size {{ $key == 0 ? "active" : "" }}" id="size{{$key}}-tab" data-toggle="tab" href="#size{{$key}}" role="tab"
                                        aria-controls="size{{$key}}" aria-selected="false" data-size_id="{{$item->size_id}}">{{$item->size_diameter}}</a>
                                </li>
                                @endforeach
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="size1" role="tabpanel" aria-labelledby="size1-tab">
                                    <ul>
                                        <li class="header">
                        ...
                        <div class="product-price" style="margin-top:15px;">
                            <div class="through">ราคาปกติ<span>{{$size[0]->size_price}}</span>บาท</div>
                            <div class="special-price">ราคาพิเศษ<span>{{$size[0]->size_price}}</span>บาท</div>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="product-quantity mb-5" id="pq">
                            <div class="product-quantity-subtract">
                                <svg class="svg-inline--fa fa-minus fa-w-14" aria-hidden="true" focusable="false"
                                    data-prefix="fa" data-icon="minus" role="img" xmlns="http://www.w3.org/2000/svg"
...
-->
    ...
    <div class="container">
        <ul id="tabs" class="nav nav-tabs hide3" role="tablist"
            style="background-color: #fff!important;border-bottom: 5px solid #ff8200 !important;color: #fff!important;">
            <li class="nav-item">
    ...
    <script type="text/javascript">
        ...
        $(".products-wheel.owl-carousel").owlCarousel({
            ...
            dots: false,
            navText: ['<img src="images/products-detail/owl-prev.png">',
                '<img src="images/products-detail/owl-next.png">'
            ],
        ...
        $(document).on('click', '.filter_size', function () {
            ...
            if (size_no != null && size_id != null) {
                $.ajax({
                url: '{{url('filter_size')}}' + '/' + size_id,
                type: 'GET',
                data: {size_no: size_no},
                }).done(function (data) {
