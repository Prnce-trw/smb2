                            ...
                            <div id="smb-contact">
                                <div class="text_about_his" id="aboutU" style="padding-right: 20px">
                                    ...
                                    <form method="POST" action="{{ url('loginUser') }}">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" id="text-white" class="btn btn-orange btn-lg btn-block">เข้าสู่ระบบ</button>
                                        </div>
                                ...
                                <div class="text_about_his" id="aboutU" style="padding-left: 20px">
                                    ...
                                    <form method="POST" action="{{url('userregister')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" name="name" class="form-control" id="Name&Lastname" placeholder="ชื่อ...">
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="lname" class="form-control" id="Name&Lastname" placeholder="นามสกุล...">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control" id="RegisterEmail" placeholder="อีเมล...">
                                        </div>
                                        <div class="form-group">
                                            <label for="Phone">หมายเลขโทรศัพท์ :</label>
                                            <input type="text" name="phone" class="form-control" id="Phone" placeholder="หมายเลขโทรศัพท์...">
                                        </div>
                                        <div class="form-group">
                                            <label for="SetPassword">รหัสผ่าน :</label>
                                            <input type="password" name="password" class="form-control" id="SetPassword" placeholder="รหัสผ่าน...">
                                        </div>
                                        <div class="form-group">
