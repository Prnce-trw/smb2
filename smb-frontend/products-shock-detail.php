...
<body>
    ...
    <div class="banner-page head-about-us-5 ">
        <div class="centered headPage-text">
            <a id="orange18" style="padding-left: 15px">หน้าหลัก / สินค้า MITSUBISHI TRITON /</a><a id="orange17"> โช้คอัพหน้า (Oil) MITSUBISHI TRITON 4X2 (4D56) '06-ON</a>
        </div>
    </div>
    <div class="container mt-5 mb-5" id="textproductI">
        <div class="row">
                    ...
                    <div class="flex-viewport" style="overflow: hidden; position: relative;">
                        <ul class="slides" style="width: 1000%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
                            <li class="flex-active-slide" style="width: 445px; margin-right: 0px; float: left; display: block;">
                                <img src="images/products-detail/shock/p01.jpg" class="img-fluid" draggable="false">
                            </li>
            ...
            <div class="col-lg-7" id="idpt">
                <div class="row">
                    <div class="col-lg-12">
                        <h4><img src="images/products-detail/shock/plogo01.png" style="max-width: 145px; max-height: 44px" alt="logo"></h4>
                        <div class="product-text mt-2">
                            <h5 id="textproducTss" class="text-black font-weight-medium">โช้คอัพหน้า (Oil) MITSUBISHI TRITON 4X2 (4D56) '06-ON</h5>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-xs-6">
                                <div class="sun-editor-editable">
                                    <p>โช้คอัพหน้า (Oil) MITSUBISHI TRITON 4X2 (4D56) '06-ON</p>
                                </div>
                                ...
                                <div class="table-responsive mb-2" style="overflow: initial;">
                                    <table style="width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td width="50%">
                                                    <h3><img src="images/icon/bath2.jpg" alt="data"> ราคาปกติต่อข้าง </h3>
                                                </td>
                                                <td align="right" width="50%" class="info_detail">
                                                    <h3>750 บาท</h3>
                                                </td>
                                    ...
                                    <div class="form-group">
                                        <div class="col text-center">
                                            <a href="products.php"><button type="button" class="btn btn-warning btn-home col-xl-5 col-md-5 mt-2"><img src=" https://www.b-quik.com/front/images/tyre.png" alt="map"> โช้คอัพทั้งหมด </button></a>
                                    ...
                                    <div class="owl-news loop owl-carousel owl-theme my-3" data-aos="fade-up">
                                        <div class="item">
                                            <div class="card newsIndex">
                                                <img class="card-img-top box-homenew-2" src="images/products-detail/shock/slide01.jpg" alt="Card image">
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="card newsIndex">
                                                <img class="card-img-top" src="images/products-detail/shock/slide01.jpg" alt="Card image">
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="card newsIndex">
