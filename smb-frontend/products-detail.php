...
<body>
    ...
    <div class="banner-page head-about-us-5 ">
        <div class="centered headPage-text">
            <a id="orange18" style="padding-left: 15px">หน้าหลัก / สินค้า COSMIS /</a><a id="orange17"> ICONIC RACING SERIES R6G</a>
        </div>
    </div>
                    ...
                    <div class="flex-viewport" style="overflow: hidden; position: relative;">
                        <ul class="slides" style="width: 1000%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
                            <li class="flex-active-slide" style="width: 445px; margin-right: 0px; float: left; display: block;">
                                <img src="images/products-detail/1.png" class="img-fluid" draggable="false">
                            </li>
                            <li style="width: 445px; margin-right: 0px; float: left; display: block;">
                                <img src="images/products-detail/2.jpg" class="img-fluid" draggable="false">
                            </li>
                            <li style="width: 445px; margin-right: 0px; float: left; display: block;">
                                <img src="images/products-detail/3.jpg" class="img-fluid" draggable="false">
                            </li>
                            <li style="width: 445px; margin-right: 0px; float: left; display: block;">
                                <img src="images/products-detail/4.jpg" class="img-fluid" draggable="false">
                            </li>
                            <li style="width: 445px; margin-right: 0px; float: left; display: block;">
                                <img src="images/products-detail/5.jpg" class="img-fluid" draggable="false">
                            </li>
                        </ul>
                    </div>
                    <ul class="flex-direction-nav">
            ...
            <div class="col-lg-7" id="idpt">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="product-text mt-2">
                            <h5 id="textproducTss" class="text-black font-weight-medium">ICONIC RACING SERIES</h5>
                        </div>
                        <div class="product-text">
                            <h2 id="textproducTss" class="text-black font-weight-medium">R6G</h2>
                        </div>
                        <div class="product-text">
                            <a>ราคา </a><a id="orange14">4,500</a><a>บาท</a>
                        </div>
                        <div class="product-text">
                            <a>MATERIAL : S-LP(Titanium)</a>
                        </div>
                        <div class="product-text">
                            <a>SIZE : 20x9.0, 22x9.0</a>
                        </div>
                        <div class="product-text">
                            <a>PCD : 6H139.7</a>
                        </div>
                        ...
                        <div class="select-size">
                            ...
                            <label for="small">17</label>
                            <label for="medium">18</label>
                            <label for="large">20</label>
                ...
                <div class="d-flex flex-wrap">
                    <div class="p-2 bd-highlight flex-product">
                        <img src="images/products-detail/delivery.jpg" alt="product">
                    </div>
                    <div class="p-2 bd-highlight flex-product">
                        <img src="images/products-detail/payment.jpg" alt="product">
                    </div>
                    <div class="p-2 bd-highlight flex-product">
                        <img src="images/products-detail/unk.jpg" alt="product">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="pane-A" class="card tab-pane fade show active mt-3 mb-5" role="tabpanel" aria-labelledby="tab-A">
                ...
                <div id="collapse-A" class="collapse show" data-parent="#content" role="tabpanel" aria-labelledby="heading-A">
                    <div class="card-body">
                        ...
                        <br>
                        <b>The Redline features a concave split 7 spoke design in either Gloss Black or Brushed Silver. Available in 18"
                            and staggered 20" for most modern muscle applications.</b><br>
                        <b>The Redline features a concave split 7 spoke design in either Gloss Black or Brushed Silver. Available in 18"
                            and staggered 20" for most modern muscle applications.</b>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="owl-news loop owl-carousel owl-theme my-3" data-aos="fade-up">
                                    <div class="item">
                                        <div class="card newsIndex">
                                            <img class="card-img-top box-homenew-2" src="images/products-detail/s1.jpg" alt="Card image">
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="card newsIndex">
                                            <img class="card-img-top" src="images/products-detail/s2.jpg" alt="Card image">
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="card newsIndex">
                                            <img class="card-img-top" src="images/products-detail/s3.jpg" alt="Card image">
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="card newsIndex">
