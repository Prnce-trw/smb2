...
<head>
        <title>Read Catalog - Naradee Store</title>
...
<body>
        ...
        <div style="background: url(images/bg-per-1.png)" class="page-holder bg-cover">
                <div class="container py-5">
                        <a href="promotion.php" class="text-black"><u>Back</u></a>
                        <h5 class="font-weight-medium mt-5 mb-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit quia nam?</h5>
