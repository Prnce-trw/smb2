                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <div class="img_product text-center">
                                <img src="images/products/a.jpg" alt="Avatar" class="image_product">
                            </div>
                            <div class="text_product">
                                <div class="product-name">
                                    <div class="about-us">
                                        <a href="products-detail.php">
                                            <h6 id="black-lr" class="color-orange-1-padding" style="padding-left: 5px;">FORCE</h6>
                                            <p>FATTAH SPORT REVUP LIMITED</p>
                                        </a>
                                    </div>
                                    <div class="product-price"><a id="orange19"> ฿1,500- ฿3,500</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="img_product text-center">
                                <img src="images/products/b.jpg" alt="Avatar" class="image_product">
                            </div>
                            <div class="text_product">
                                <div class="product-name">
                                    <div class="about-us">
                                        <a href="products-detail.php">
                                            <h6 id="black-lr" class="color-orange-1-padding" style="padding-left: 5px;">NAYA</h6>
                                            <p>NAYA SPIRITS SERIES LOTUS V.6 LIMITED</p>
                                        </a>
                                    </div>
                                    <div class="product-price"><a id="orange19"> ฿1,500- ฿3,500</a></div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="img_product">
                                <img src="images/products/c.jpg" alt="Avatar" class="image_product">
                            </div>
                            <div class="text_product">
                                <div class="product-name">
                                    <div class="about-us">
                                        <a href="products-detail.php">
                                            <h6 id="black-lr" class="color-orange-1-padding" style="padding-left: 5px;">COSMIS</h6>
                                            <p>COSMIS RACNING SERIES</p>
                                        </a>
                                    </div>
                                    <div class="product-price"><a id="orange19"> ฿1,500- ฿3,500</a></div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="img_product">
                                <img src="images/products/d.jpg" alt="Avatar" class="image_product">
                            </div>
                            <div class="text_product">
                                <div class="product-name">
                                    <div class="about-us">
                                        <a href="products-detail.php">
                                            <h6 id="black-lr" class="color-orange-1-padding" style="padding-left: 5px;">VALENZA</h6>
                                            <p>VALENZA SPIRIOR</p>
                                        </a>
                                    </div>
                                    <div class="product-price"><a id="orange19"> ฿1,500- ฿3,500</a></div>
