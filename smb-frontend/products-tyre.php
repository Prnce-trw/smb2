                ...
                <div class="wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
                    <div class="pd-tyre row">
                        <div class="img_product col-12 col-md-3">
                            <img src="images/products-detail/T1.jpg" alt="Avatar" class="image_product">
                        </div>
                        <div class="text_product col-12 col-md-9">
                            <div class="about-us">
                                <div class="col-left">
                                    <div class="product-text">
                                        <img src="images/products-detail/tyre-logo.png">
                                        <p class="series-mobel">EAGLE F1 ASYMMETRIC 5</p>
                                        <p class="size-mobel">195R14 AGILIS <span class="label"><img src="images/label-special.png"></span></p>
                                        <div class="sub-item">
                                ...
                                <div class="col-right">
                                    <a class="popup-detail" data-toggle="modal" data-target="#exampleModal"><img src="images/products-detail/detail-tyre.jpg" class="image_product"></a>
                                    
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <img src="images/products-detail/detail-tyre-popup.jpg" class="image_product">
                                            </div>
                                        </div>
                                    </div>
