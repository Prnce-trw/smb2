        ...
        <div class="body">
            <div class="row">
                <div class="col-lg-4 tcn about-company" style="margin-right: 140px;">
                    <a class="navbar-brand2" href="#" style="padding-bottom: 15px;">
                        <img src="images/smb-logo.png" weight="150px" height="50px" alt="logo">
                    </a>
                    <p-1 class="card-title_b">
                        ศูนย์บริการล้อแม็ก ยาง และอุปกรณ์ตกแต่งรถยนต์
                        ชั้นนำของเมืองไทย เราเป็นผู้ให้บริการชั้นนำในเรื่อง
                ...
                <div class="col-lg-2 links tcn pt-3 mr-4">
                    ...
                    <p class="small text-secondary mb-0" style="font-size: 16px"><a href="tel:085-162-3232" id="text-some" style="font-size: 16px">TEL:</a> 085-162-3232</p>
                    <p class="small text-secondary mb-0" style="font-size: 16px"><a href="https://page.line.me/smbwheel" id="text-some" style="font-size: 16px">LINE:</a> @smbwheel</p>
                </div>
                ...
                -->
                    ...
                    <div class="col-12" style="padding-left: 0px;">
                        <a href="#"><img src="images/facebook.png" width="30" height="20" title="facebook" alt="facebook" style="margin-right: 5px;"></a>
                        <a href="#"><img src="images/twitter.png" width="30" height="20" title="line" alt="line" style="margin-right: 5px;"></a>
                        <a href="#"><img src="images/youtube.png" width="30" height="20" title="youtube" alt="youtube" style="margin-right: 5px;"></a>
                    </div>
                </div>
            </div>
        </div>
